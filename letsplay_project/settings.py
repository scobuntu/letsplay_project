# Django settings for letsplay_project project.
import os.path
...
FIXTURE_DIRS = (
   project_path('letsplay_project/letsplay/fixtures'),
)
...
STATICFILES_DIRS = (
    project_path('letsplay_project/static'),
)
...
ROOT_URLCONF = 'letsplay_project.urls'
